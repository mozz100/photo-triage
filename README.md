...
# Open web browser on computer, smart phone or tablet, use arrow and number keys or swipes and clicks to rate photos.
...
--less-than RATING         Output list of all photos with rating less than that specified
--less-than RATING remove  Remove photos with rating less than RATING.  Removes all files matching
                           the photo's name.
```
